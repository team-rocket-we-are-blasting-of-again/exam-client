        ...
        .then((d) => {
          setRegistrationMsg(
            <div id="successRegisterCourier">
              Hej, <span id="createdFirstName">{d.firstName}</span>! Your userId
              is <span id="createdUserId">{d.userId}</span>, and courierId is{" "}
    ...
    <Row>
      <form id="RegisterCourierForm" onChange={onChange}>
        ...
        <input
          ...
          id="password"
        />
        <button id="registerCourierBtn" onClick={registerCourier}>
          Register courier
        </button>{" "}
        <br />
